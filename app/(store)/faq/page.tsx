...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "يتم احتساب تكلفة التركيب بناءً على المساحة ونوع المنتج المختار. تواصل معنا عبر صفحة اتصل بنا للحصول على استشارة مجانية، أو اطلب معاينة من مهندسنا لمساحة موقعك.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "نقوم بالتوصيل خلال 2-5 أيام عمل داخل الضفة الغربية، مع إمكانية التوصيل السريع خلال 24 ساعة للطلبات المستعجلة. نوفر شحن مجاني للطلبات الكبيرة.",
  },
  {
